...
/** Clickable room/POI rects over the floor plan — the reference prototype's `#hotspotLayer`. */
export const HotspotLayer = ({ activeCode, onSelectLocation, wasDragging }: HotspotLayerProps) => (
  <g>
