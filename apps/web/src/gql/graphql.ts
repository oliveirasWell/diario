...
export type ClassesQuery = {
  __typename?: "Query";
  classes: Array<{ __typename?: "Class"; id: string; name: string; year: number; ownerId: string }>;
};
...
export type EnrollmentsQuery = {
  ...
  enrollments: Array<{
    ...
    id: string;
    concept?: string | null;
    student: { __typename?: "Student"; id: string; name: string; email?: string | null };
  }>;
};
...
export type AttendanceRecordsQuery = {
  ...
  attendanceRecords: Array<{
    ...
    enrollmentId: string;
    status: AttendanceStatus;
    session: { __typename?: "AttendanceSession"; id: string; date: string };
  }>;
};
...
export type GradesByClassQuery = {
  __typename?: "Query";
  gradesByClass: Array<{
    __typename?: "Grade";
    id: string;
...
export type CreateClassMutation = {
  __typename?: "Mutation";
  createClass: { __typename?: "Class"; id: string; name: string; year: number; ownerId: string };
};
...
export type RenameClassMutation = {
  __typename?: "Mutation";
  renameClass: { __typename?: "Class"; id: string; name: string; year: number };
};
...
export type CreateAndEnrollMutation = {
  __typename?: "Mutation";
  createAndEnroll: { __typename?: "Enrollment"; id: string };
};
...
export type RenameStudentMutation = {
  __typename?: "Mutation";
  renameStudent: {
    __typename?: "Enrollment";
    id: string;
...
export type UpsertGradeMutation = {
  __typename?: "Mutation";
  upsertGrade: {
    __typename?: "Grade";
    id: string;
...
export type SetConceptMutation = {
  __typename?: "Mutation";
  setEnrollmentConcept: { __typename?: "Enrollment"; id: string };
};
...
export type UpdateClassScheduleMutation = {
  __typename?: "Mutation";
  updateClassSchedule: { __typename?: "Class"; id: string };
};
...
} as unknown as DocumentNode<ClassQuery, ClassQueryVariables>;
export const HdrClassDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "HdrClass" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<HdrClassQuery, HdrClassQueryVariables>;
...
} as unknown as DocumentNode<AttendanceDatesQuery, AttendanceDatesQueryVariables>;
export const AttendanceRecordsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AttendanceRecords" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "classId" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "enrollmentId" } },
...
} as unknown as DocumentNode<AttendanceRecordsQuery, AttendanceRecordsQueryVariables>;
...
export const GradesByClassDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GradesByClass" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "classId" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "enrollmentId" } },
                { kind: "Field", name: { kind: "Name", value: "evaluationId" } },
...
} as unknown as DocumentNode<GradesByClassQuery, GradesByClassQueryVariables>;
...
export const DelClassDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DelClass" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<DelClassMutation, DelClassMutationVariables>;
export const RenameClassDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RenameClass" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<RenameClassMutation, RenameClassMutationVariables>;
export const CreateAndEnrollDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateAndEnroll" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "classId" } },
...
} as unknown as DocumentNode<CreateAndEnrollMutation, CreateAndEnrollMutationVariables>;
export const UnenrollDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Unenroll" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "unenrollStudent" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<UnenrollMutation, UnenrollMutationVariables>;
...
} as unknown as DocumentNode<RenameStudentMutation, RenameStudentMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: { kind: "NamedType", name: { kind: "Name", value: "AttendanceStatus" } },
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
...
} as unknown as DocumentNode<MarkAttendanceMutation, MarkAttendanceMutationVariables>;
export const MarkAllPresentDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "MarkAllPresent" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "classId" } },
...
} as unknown as DocumentNode<MarkAllPresentMutation, MarkAllPresentMutationVariables>;
export const ExDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Ex" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "classId" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "excludeAttendanceDate" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "classId" },
...
} as unknown as DocumentNode<ExMutation, ExMutationVariables>;
export const CreateEvaluationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<CreateEvaluationMutation, CreateEvaluationMutationVariables>;
export const DelEvalDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DelEval" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<DelEvalMutation, DelEvalMutationVariables>;
export const UpsertGradeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpsertGrade" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "enrollmentId" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "evaluationId" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
          },
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "evaluationId" } },
              },
              {
                kind: "Argument",
...
} as unknown as DocumentNode<UpsertGradeMutation, UpsertGradeMutationVariables>;
export const SetConceptDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SetConcept" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "enrollmentId" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "concept" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
        },
      ],
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "setEnrollmentConcept" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "enrollmentId" },
              ...
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "concept" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<SetConceptMutation, SetConceptMutationVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "daysOfWeek" } },
          type: {
            kind: "ListType",
            type: {
              kind: "NonNullType",
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "daysOfWeek" } },
              },
              {
                kind: "Argument",
...
} as unknown as DocumentNode<UpdateClassScheduleMutation, UpdateClassScheduleMutationVariables>;
